...
for (i in pid){
  ...
  save(RF,file =paste0("E:/targetprofiling/model/RF","/",i,".maccs.Rdata"))
  RFmaccsper[i] = RF$err.rate[500,1]
  print(i)
}

############################################################################
save(RFmaccsper,file ="E:/targetprofiling/model/RFmaccsper.Rdata")